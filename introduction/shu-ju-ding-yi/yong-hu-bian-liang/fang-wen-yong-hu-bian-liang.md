...
##  <a id="fang-wen-yong-hu-jian-jie"></a>

访问用户是 GrowingIO 对访问您的应用（包括网页、App、微信小程序等，下同）的用户的一种识别机制。每一个访问您的应用的用户都会在对应的设备中生成并记录一个唯一的 ID，我们称之为访问用户 ID。

对于不同平台类型的应用，GrowingIO 提供了多种识别方案，从而尽可能的实现对用户的唯一标识。访问用户在不同平台的标识请参考[访问用户模型文档](https://docs.growingio.com/docs/data-model/user-model/visitor)。
...
* ​[​JS 接口文档​](https://docs.growingio.com/docs/sdk-integration/web-js-sdk/web-js-sdk-api#16-she-zhi-fang-wen-yong-hu-ji-bian-liang-visitorset)​
