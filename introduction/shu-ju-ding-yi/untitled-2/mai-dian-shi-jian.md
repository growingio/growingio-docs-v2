...
在 GrowingIO 上着手进行任何分析之前，首先要确定的一个问题是：如何设计“指标 + 维度”的体系？对于无埋点数据，我们通过圈选确定“指标”，而“维度”则由 GrowingIO 提供了数个[预定义的维度](https://docs.growingio.com/docs/data-model/olap-model/predifined-metrics-dimensions)。对于自定义数据，我们可以相对更自由地选择“指标 + 维度”的体系。
...
商品ID/名称、优惠券名称等维度，则可以通过下一章节的[事件级变量](https://docs.growingio.com/docs/data-definition/custom-event#shi-jian-ji-bian-liang-pei-zhi)来实现，此处先不展开。
...
![](https://docs.growingio.com/.gitbook/assets/3%20%286%29.png)埋点事件

填入自定义事件配置界面，如下图：![](https://docs.growingio.com/.gitbook/assets/4%20%281%29.png)埋点事件配置
