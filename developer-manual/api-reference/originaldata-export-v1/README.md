...
获取连接：获取请求API的响应中的downloadLinks，参见[按事件类型导出原始数据](../originaldata-export-v2/definition/eventtype.md)和[导出全部事件类型原始数据](../originaldata-export-v2/definition/alltype.md)。
